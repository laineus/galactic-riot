...
const self = {
  ...
  created: () => {
    ...
    new AddComputer(1500, 5800, 270, 'player', self.friendCount)
  },
  update: () => {
  },
  functions: [
    () => {
      new AddComputer(1200, 0, 80, 'enemy', 5)
      new AddComputer(1800, 3000, 100, 'enemy', 5)
      return true
    },
    ...
    () => {
      new AddComputer(3000, 3000, 180, 'enemy', 2)
      new AddComputer(3900, 2000, 170, 'enemy', 3)
      new AddComputer(4700, 2500, 180, 'enemy', 2)
      new AddComputer(5500, 2700, 175, 'enemy', 3)
      new AddComputer(6500, 3000, 170, 'enemy', 2)
      return true
    },
    () => !state.field.enemy.children.length,
    () => {
    ...
    () => {
      if (self.route === 1) {
        new AddComputer(8000, 1400, 180, 'enemy', 3)
        new AddComputer(5500, 1600, 180, 'enemy', 4)
        new AddComputer(3000, 1500, 180, 'enemy', 5)
      }
      if (self.route === 2) {
        new AddComputer(1800, 8000, 270, 'enemy', 3)
        new AddComputer(2200, 5500, 270, 'enemy', 5)
        new AddComputer(2000, 3000, 270, 'enemy', 5)
      }
      return true
    },
    () => !state.field.enemy.children.length,
    ...
    () => {
      new AddComputer(2000, 2000, 225, 'enemy', 6)
      return true
    },
    () => !state.field.enemy.children.length,
    () => {
    ...
    () => {
      new AddComputer(2500, 1500, 180, 'enemy', 2)
      new AddComputer(6000, 2200, 185, 'enemy', 3)
      new AddComputer(9000, 1800, 180, 'enemy', 2)
      new AddComputer(12000, 2700, 190, 'enemy', 3)
      return true
    },
    () => !state.field.enemy.children.length,
    ...
    () => {
      new AddComputer(1000, 3000, 85, 'enemy', 3)
      new AddComputer(3000, 1000, 95, 'enemy', 4)
      new AddComputer(1500, -2000, 85, 'enemy', 5)
      new AddComputer(2500, -6000, 95, 'enemy', 6)
      return true
    },
    () => !state.field.enemy.children.length
  ]
