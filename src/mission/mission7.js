...
const self = {
  ...
  created: () => {
    ...
    new AddComputer(1400, 200, 90, 'player', self.friendCount)
  },
  update: () => {
  },
  functions: [
    () => {
      new AddComputer(900, 3100, 280, 'enemy', 3)
      new AddComputer(2100, 4500, 260, 'enemy', 4)
      new AddComputer(1500, 6600, 270, 'enemy', 4)
      return true
    },
    ...
    () => {
      new AddComputer(4500, 3000, 290, 'enemy', 4)
      new AddComputer(0, 2000, 340, 'enemy', 5)
      new AddComputer(-3000, 1500, 350, 'enemy', 4)
      return true
    },
    () => !state.field.enemy.children.length,
    ...
    () => {
      new AddComputer(1500, 200, 90, 'enemy', 6)
      return true
    },
    () => !state.field.enemy.children.length,
    ...
    () => {
      new AddComputer(5500, 1500, 60, 'enemy', 3)
      new AddComputer(2500, 1200, 30, 'enemy', 5)
      return true
    },
    () => !state.field.enemy.children.length,
    () => {
      new AddComputer(0, 1000, 40, 'enemy', 4)
      new AddComputer(0, 2500, 0, 'enemy', 4)
      return true
    },
    () => !state.field.enemy.children.length,
    ...
    () => {
      new AddComputer(2800, 2000, 260, 'enemy', 4)
      new AddComputer(1200, 5000, 280, 'enemy', 5)
      new AddComputer(2000, 8000, 270, 'enemy', 6)
      return true
    },
    () => !state.field.enemy.children.length,
    ...
    () => {
      new AddComputer(5000, 2300, 360, 'enemy', 2)
      new AddComputer(2500, 1800, 20, 'enemy', 3)
      new AddComputer(0, 2700, 0, 'enemy', 3)
      return true
    },
    () => !state.field.enemy.children.length
  ]
